...
data<-data_no2_by_monitor%>%
  bind_rows(data_no2_by_monitor%>%
              filter(State.Name=="pennsylvania",!monitor==4)%>%
...
nweeks<-8
states<-c("maryland","massachusetts","new york","pennsylvania","district of columbia","pennsylvaniacomplete")
...
save(settings,file = "results/sensitivity/mean_difference_significance_levels_3yrs.RData")
